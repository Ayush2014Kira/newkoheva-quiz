...
function FirstQuestion(props, prox) {
  const options = [""];
  ...
  return (
    <div className="d-flex flex-column align-items-center main_que_container">
      ...
      {/* <div className="hi_text animate__animated animate__fadeInUp">
        Hi, {props.name}
      </div> */}
      {/* <div className="animate__animated animate__fadeInUp animate__delay-0.5s">
        <h4>Find Out Actual Koheva Product...</h4>
      </div> */}
      ...
      <div className="row que_container animate__animated animate__fadeInLeft mt-5">
